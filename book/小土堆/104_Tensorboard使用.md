...
```
```
Requirement already satisfied: tensorboard in d:\11_anaconda\envs\py3.6.3\lib\site-packages (2.8.0)
Requirement already satisfied: grpcio>=1.24.3 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (1.44.0)
Requirement already satisfied: requests<3,>=2.21.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (2.27.1)
Requirement already satisfied: tensorboard-data-server<0.7.0,>=0.6.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (0.6.1)
Requirement already satisfied: absl-py>=0.4 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (1.0.0)
Requirement already satisfied: werkzeug>=0.11.15 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (2.0.3)
Requirement already satisfied: protobuf>=3.6.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (3.19.4)
Requirement already satisfied: google-auth<3,>=1.6.3 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (2.6.2)
Requirement already satisfied: google-auth-oauthlib<0.5,>=0.4.1 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (0.4.6)
Requirement already satisfied: markdown>=2.6.8 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (3.3.6)
Requirement already satisfied: setuptools>=41.0.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (58.0.4)
Requirement already satisfied: tensorboard-plugin-wit>=1.6.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (1.8.1)
Requirement already satisfied: wheel>=0.26 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (0.37.1)
Requirement already satisfied: numpy>=1.12.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from tensorboard) (1.19.5)
Requirement already satisfied: six in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from absl-py>=0.4->tensorboard) (1.16.0)
Requirement already satisfied: pyasn1-modules>=0.2.1 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from google-auth<3,>=1.6.3->tensorboard) (0.2.8)
Requirement already satisfied: cachetools<6.0,>=2.0.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from google-auth<3,>=1.6.3->tensorboard) (4.2.4)
Requirement already satisfied: rsa<5,>=3.1.4 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from google-auth<3,>=1.6.3->tensorboard) (4.8)
Requirement already satisfied: requests-oauthlib>=0.7.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from google-auth-oauthlib<0.5,>=0.4.1->tensorboard) (1.3.1)
Requirement already satisfied: importlib-metadata>=4.4 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from markdown>=2.6.8->tensorboard) (4.8.3)
Requirement already satisfied: typing-extensions>=3.6.4 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from importlib-metadata>=4.4->markdown>=2.6.8->tensorboard) (3.10.0.2)
Requirement already satisfied: zipp>=0.5 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from importlib-metadata>=4.4->markdown>=2.6.8->tensorboard) (3.6.0)
Requirement already satisfied: pyasn1<0.5.0,>=0.4.6 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from pyasn1-modules>=0.2.1->google-auth<3,>=1.6.3->tensorboard) (0.4.8)
Requirement already satisfied: urllib3<1.27,>=1.21.1 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from requests<3,>=2.21.0->tensorboard) (1.26.9)
Requirement already satisfied: certifi>=2017.4.17 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from requests<3,>=2.21.0->tensorboard) (2021.5.30)
Requirement already satisfied: idna<4,>=2.5 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from requests<3,>=2.21.0->tensorboard) (3.3)
Requirement already satisfied: charset-normalizer~=2.0.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from requests<3,>=2.21.0->tensorboard) (2.0.12)
Requirement already satisfied: oauthlib>=3.0.0 in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from requests-oauthlib>=0.7.0->google-auth-oauthlib<0.5,>=0.4.1->tensorboard) (3.2.0)
Requirement already satisfied: dataclasses in d:\11_anaconda\envs\py3.6.3\lib\site-packages (from werkzeug>=0.11.15->tensorboard) (0.8)
...
writer.close()
```
![image-20250607161929545](104_Tensorboard使用.assets/image-20250607161929545.png)

![image-20250607161937773](104_Tensorboard使用.assets/image-20250607161937773.png)

# 3. Tensorboard 读日志
① 在 Anaconda 终端里面，激活py3.6.3环境，再输入 tensorboard --logdir=C:\Users\wangy\Desktop\03CV\logs 命令，将网址赋值浏览器的网址栏，回车，即可查看tensorboard显示日志情况。

![image.png](104_Tensorboard使用.assets/image_3.png)

② 为避免多人使用端口导致冲突，也可以在后面加上后缀，使得端口独立，tensorboard --logdir=C:\Users\wangy\Desktop\03CV\logs --port=6008

![image.png](104_Tensorboard使用.assets/image_4.png)

③ 输入网址可得Tensorboard界面。

![image.png](104_Tensorboard使用.assets/image_5.png)
...
img_path2 = "Data/SecondTypeData/train/bees_image/17209602_fe5a5a746f.jpg"  #图片路径 
...
writer.close()
```
![image-20250607162023409](104_Tensorboard使用.assets/image-20250607162023409.png)
